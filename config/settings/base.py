...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///journal_app")
}
...
MIGRATION_MODULES = {"sites": "journal_app.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "journal:entry_list"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "journal_app.utils.context_processors.settings_context",
            ],
        },
    }
]
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="No Reply <noreply@cjstein.com>"
)
...
ADMINS = [("""CJ Stein""", "resume@cjstein.com")]
